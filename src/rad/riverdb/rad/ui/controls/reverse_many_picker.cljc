(ns riverdb.rad.ui.controls.reverse-many-picker
  (:require
...
(defsc ManyToManyPicker [this {:keys [env attr]}]
...
(def ui-to-many-picker (comp/factory ManyToManyPicker {:keyfn :id}))
(let [ui-to-many-picker (comp/factory ManyToManyPicker {:keyfn (fn [{:keys [attr]}] (::attr/qualified-key attr))})]
